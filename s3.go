...
$ git clone https://github.com/juan-carlos-trimino/gps3storage.git

Initialize Go.
$ cd gps3storage
Execute "go mod init github.com/{GitHub-Username}/{Repo-Name}
$ go mod init github.com/juan-carlos-trimino/gps3storage
...
$ go get -u github.com/juan-carlos-trimino/gps3storage
